...
namespace BLTAdoptAHero
{
    ...
    internal class SummonHero : HeroActionHandlerBase
    {
                    ...
                    playerWon =>
                    {
                        ...
                        if (!playerWon)
                        {
                            ...
                            ActionManager.SendReply(context,
                                $"You won {BLTAdoptAHeroModule.CommonConfig.WinGold}{Naming.Gold}!");
                        }
                        else if (BLTAdoptAHeroModule.CommonConfig.LoseGold > 0)
                        {
                            ...
                            ActionManager.SendReply(context,
                                $"You lost {BLTAdoptAHeroModule.CommonConfig.WinGold}{Naming.Gold}!");
                        }
                    });
            }
            ...
            Action<string> onFailure)
        {
            ...
            {
                onFailure($"{heroSummonState.CooldownRemaining:0}s cooldown remaining");
                return;
            }
